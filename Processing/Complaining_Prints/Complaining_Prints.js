  let slider1,  slider3, slider4, slider7, instaslider;
...
let img_pattern;
  ...
  function preload() {
  img_logo = loadImage('s.w.png');
  img = loadImage('frame.png');
  img_pattern = loadImage('pattern.png');
  ...
  function setup_1(){
   ...
   createCanvas(windowWidth, windowHeight);
    ...
    imageMode(CENTER);
    image(img_pattern,windowWidth/2, windowHeight/2,windowWidth, windowHeight);
    //frame
    //imageMode(CENTER);
    ...
    //save image button
    let col = color(223, 30, 100);
    //let shape = rect(windowWidth / 2 - 35, windowHeight / 9 + 525, 60, 30, 20);
    button = createButton('Save Image');
    button.style('background-color', col);
    //button.style('shape', shape);
   ...
   slider7.size (150, 1);
    ...
    strokeWeight(1);
    stroke(223, 20, 100);
    text('Line colour picker', windowWidth / 2 - 500, windowHeight / 2 - 130);
    ...
    stroke(223, 20, 100);
    fill(222, 0,0);
    text('Background colour picker', windowWidth / 2 - 530, windowHeight / 2 - 80);
    ...
    textFont("Mattire");
    stroke(223, 30, 100);
    text('Talk to me about your complaints, Move those sliders to make your unique drawings.', 0, 700, width);
  ...
  textAlign(CENTER, CENTER);
  textFont("Mattire");
  text('Complaining', 0, 350, width);
  text('Prints', 0, 420, width);
  ...
  textAlign(CENTER, CENTER);
  textFont("Mattire");
  text('"Here is a place to vent your emotions and comlpaints.', 0, 500, width);
  text('Just say it out loud, ', 0, 520, width);
  text('and your complaints will transform into a drawing."', 0, 540, width);
 ...
 bigCanvas.background(50,30,100);
  ...
  //fucntion save image
  function saveImage() {
    saveCanvas(smallCanvas, 'myPrints', 'jpg');
  }
